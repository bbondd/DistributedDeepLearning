...
class EnsembleModel(object):
    ...
    def get_accuracy(self):
        self.accuracy_with_models = [(ray.get(accuracy), model) for accuracy, model in self.accuracy_with_models]
        ...
        for i in range(len(predict_models)):
            ...
            k.utils.plot_model(ray.get(predict_models[i].get_model.remote()), to_file='./models/model%d.png' % i, show_shapes=True)
