...
class EnsembleModel(object):
    ...
    def train_new_model(self):
        ...
        for random_model in random_models:
            random_model.train()
            self.accuracy_with_models.append((random_model.get_accuracy(), random_model))
    ...
    def get_accuracy(self):
        ...
        for i in range(len(predict_models)):
            predicts += predict_models[i].predict(self.data.test_x)
            k.utils.plot_model(predict_models[i].model, to_file='./models/model%d.jpg' % i, show_shapes=True)
